namespace RTCV.Launcher
{
    ...
    #region JsonV6
    public class LauncherConfJsonV6
    {
        public string LauncherAssetLocation;
        public string LauncherConfLocation;
        public string[] LauncherAddonConfLocations;
        ...
        public LauncherConfJsonItemV6[] Items = { };

        public LauncherConfJsonV6(string _version)
        {
            Version = _version;
            LauncherAssetLocation = Path.Combine(MainForm.launcherDir, "VERSIONS", Version, "Launcher");
            LauncherConfLocation = Path.Combine(LauncherAssetLocation, "launcher.json");
            ...
            var launcherJson = File.ReadAllText(LauncherConfLocation);
            var lcjiList = new List<LauncherConfJsonItemV6>();
            lcjiList.AddRange(JsonConvert.DeserializeObject<LauncherConfJsonItemV6[]>(launcherJson));
            ...
            foreach (var addonJsonConfLocation in LauncherAddonConfLocations)
            {
                ...
                {
                    var addonJson = File.ReadAllText(addonJsonConfLocation);
                    var addonConfigs = JsonConvert.DeserializeObject<LauncherConfJsonItemV6[]>(addonJson);
    ...
    [SuppressMessage("Microsoft.Design", "CA1812: Avoid uninstantiated public classes", Justification = "Passed as a type parameter")]
    public class LauncherConfJsonItemV6
    {
        [JsonProperty]
        public readonly string FolderName;
        [JsonProperty]
        ...
        public LauncherConfJsonItemV6(string imageName, string downloadVersion, string folderName, ReadOnlyDictionary<string, ExecutableCommand> executableCommands, string itemName, string itemSubtitle, string itemDescription, bool hideItem, bool isAddon, string configFilename)
        {
            ImageName = imageName;
            DownloadVersion = downloadVersion;
            FolderName = folderName;
    ...
    public interface ILauncherJsonConfPanelV6 : ILauncherJsonConfPanel
    {
        LauncherConfJsonV6 GetLauncherJsonConf();
    }
